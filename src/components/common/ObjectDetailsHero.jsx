    ...
    return (
        <>
            <div
                ...
                style={{
                    backgroundImage: backgroundImage ? `url(${backgroundImage})` : 'radial-gradient(circle at 20% 10%, #3b1a20, #111 55%)',
                ...
                <div className="content-details-wrapper">
                    ...
                    <div className="details-text-content">
                        ...
                        <div className="valoration-container">
                            ...
                            <p>{rating} / 10 ({numVotes} {t("votes")})</p>
                        </div>
                        {isMovie ? (
                            <p className="duration-info">{first_air_date} | {runtime} min</p>
                        ) : (
                            <p className="duration-info">
                                {first_air_date} | {number_of_seasons} {number_of_seasons === 1 ? t("season") : t("seasons")}
                            </p>
                        )}
